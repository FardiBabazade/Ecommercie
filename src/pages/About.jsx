            ...
            <div className='container'>
                <div className='row'>
                    <div className='col-md-12'>
                        <h3 className={styles.textAbout}>About</h3>
                       <h4>Lorem ipsum</h4>
                       <p>lorem lorem lorem loremlorem loremlorem loremlorem loremlorem
                         loremlorem loremlorem loremlorem loremlorem loremlorem lorem
                         ...
                         lorem loremlorem loremlorem loremlorem loremlorem loremlorem lorem
                         lorem loremlorem loremlorem loremlorem loremlorem lorem
                         oremlorem loremlorem loremlorem loremlorem loremlorem lorem
                         lorem loremlorem loremlorem loremlorem loremlorem loremlorem 
                         lorem loremlorem loremlorem loremlorem loremlorem lorem
                         lorem loremlorem loremlorem loremlorem loremlorem loremlorem 
                         lorem loremlorem loremlorem loremlorem loremlorem lorem
